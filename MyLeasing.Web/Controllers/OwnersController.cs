    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(string.Empty, "User With this emaild already exists.");
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "The property cant't be deleted because it has contracts");
